...
6. Define a `rollback_strategy` paragraph. Default behavior: leave the failing partition empty and emit a clear failure event in the pipeline log; do not auto-truncate previously loaded partitions.
